...
var prepareChunkVariations = function prepareChunkVariations(images, maxChunks) {
  ...
  if (maxChunks === 3) {
    ...
    try {
      for (var _iterator5 = variants[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
        ...
        for (var _i = 0; _i < p2.length; _i++) {
          if (_i === 0) continue;
          var v = [p1, p2.slice(0, _i), p2.slice(_i, p2.length)];
          moreVariants.push(v);
        }
      }
    } catch (err) {
    ...
    try {
      for (var _iterator6 = moreVariants[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
        var _v = _step6.value;
        variants.push(_v);
      }
    } catch (err) {
...
var prepareVariants = function prepareVariants(images) {
  ...
  try {
    for (var _iterator7 = variations[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
      var v = _step7.value;
...
var getOptimalVariant = function getOptimalVariant(images, options) {
  ...
  try {
    for (var _iterator8 = variants[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
  ...
  if (variant.singleRow) {
    ...
    try {
      for (var _iterator11 = _row.images[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
        ...
        try {
          for (var _iterator12 = col.images[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
            var nestedImage = _step12.value;
    ...
    try {
      for (var _iterator13 = _col.images[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
        var _row2 = _step13.value;
        var _iteratorNormalCompletion14 = true;
        var _didIteratorError14 = false;
        var _iteratorError14 = undefined;

        try {
          for (var _iterator14 = _row2.images[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
            var _nestedImage = _step14.value;
...
var fixVerticalImages = function fixVerticalImages(images) {
  ...
  try {
    for (var _iterator15 = images[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
...
//# sourceMappingURL=imagallery.min.js.map